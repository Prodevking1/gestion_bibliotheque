	...
	<div class="col-md-8">
		...
		<div class="card" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
			...
			<div class="card-body"  style="text-transform : uppercase; font-family: Lato;">
				<form method="POST" class="row g-3" action="{{ route('reservations.store')}}" enctype="multipart/form-data">
					...
					<div class="col-md-6">
						...
						<select class="form-select" name="livre_id" required>
							<option value="" selected disabled>Selectionnez un livre </option>
				...
				<!-- Date de reservation -->
                <div class="col-md-6">
						<label class="form-label" style="font-weight: bold;">Date de reservatiion</label>
						<input type="date" name="date_reservation" id="date_reservation" class="form-control" placeholder="jj/mm/aaaa" required/>
				</div>
					...
					<div class="col-md-6 mt-2">
						...
						<input type="submit" class="btn btn-outline-primary btn-block" value="Reserver" />
					</div>
					</div>
